...
%
%
\input{src/01-body/01-bab1} % Pendahuluan
\input{src/01-body/02-bab2} % Tinjauan Kepustakaan
\input{src/01-body/03-bab3} % Metodologi Penelitian
\input{src/01-body/04-bab4} % Hasil dan Pembahasan
\input{src/01-body/05-bab5} % Kesimpulan dan Saran
